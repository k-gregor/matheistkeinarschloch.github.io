...
Die quadratischen Matrizen bilden keinen Körper, weil nicht zu jedem Element ein multiplikatives [Inverses]({{ "/invertierbare-matrizen-und-ihre-eigenschaften/" | relative_url }}) existiert und weil die Multiplikation nicht kommutativ ist.
